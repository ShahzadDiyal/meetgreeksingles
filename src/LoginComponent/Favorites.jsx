...
const Favorites = () => {
  ...
  const NewMatchHandler = (lat, long) => {
    fetchData(
      `${basUrl}new_match.php`,
      { lat, long, listName: "profilelist" },
      setNewMatch,
      setTotalCards,
      currentIndex,
      setCurrentIndex
  ...
  const FavouritrHandler = (lat, long) => {
    fetchData(
      `${basUrl}favourite.php`,
      { lat, long, listName: "favlist" },
      setFavourite,
      setTotalCards2,
      currentIndex2,
      setCurrentIndex2
            ...
            <div className="col-xl-12 max-_1030_:sticky top-[70px] max-_1030_:z-[555] bg-[#e5e5e5] ">
              <div className="card card-rounded my-[20px] max-_430_:my-3">
                <div className="py-[20px] px-[20px] max-_430_:py-[10px] max-_430_:px-[0px] scroll-container2 mx-[10px]">
                  <div className="flex items-center gap-[20px] w-[100%] overflow-x-auto">
                    {["Match", "Like", "Favorite", "Passed"].map((pageName) => (
                      <button
                        key={pageName}
                        onClick={() => ShowPageHandler(pageName)}
                        style={{
                          color: showPage === pageName ? "white" : "#1F5799",
                          background:
                            showPage === pageName ? "#1F5799" : "#970eff31",
                        }}
                        className="inline-block p-[12px_20px] max-_430_:p-[10px_12px] rounded-full transition duration-300 flex items-center gap-[6px] whitespace-nowrap hover:opacity-90"
                      >
                        <svg
                          width="25"
                          height="25"
                        ...
                        >
                          <path
                            ...
                            fill={showPage === pageName ? "white" : "#970eff31"}
                            stroke="#0066CC"
                            strokeWidth="2"
                          />
                        </svg>
