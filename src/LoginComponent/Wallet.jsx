...
const Wallet = () => {
    ...
    return (
                        ...
                        <div className="col-xl-12 max-_430_:fixed max-_430_:rounded-[10px] max-_430_:bg-[#e5e5e5] top-[70px] left-0 right-0 z-[444] max-_430_:pt-[15px]">
                            <div className="card card-rounded mb-4">
                                <div className="card-body card-py-1 flex justify-between items-center">
                                    ...
                                    <button onClick={() => { setToggleButton(true); setPageName("Wallet") }} className="flex items-center gap-[10px] bg-[#0066CC] text-[#333333] rounded-full px-[8px] py-[5px]"  style={{
        background: "#1F5799",       
        borderRadius: "999px",        
      ...
      onMouseOut={(e) => e.currentTarget.style.background = "#1F5799"}>
                                        ...
                                        <h6 className='mt-[8px] text-[#ffffff]'>{t("Top-up")}</h6>
                                    </button>
                                </div>
                            </div>
                        </div>
