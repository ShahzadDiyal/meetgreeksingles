                      ...
                      <div className="bg-white mx-[20px] p-[16px] my-[30px] rounded-[0.56rem]">
                        <div className="max-w-2xl mx-auto my-3">
                          ...
                          <form onSubmit={handleSubmit} className="space-y-3">
                            ...
                            <button
                              type="submit"
                              className="text-xl w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-200 font-medium"
                            >
                              Send Message
                            </button>
                          </form>
